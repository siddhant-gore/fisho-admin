...
import { useDeleteBulkOrderByIdMutation, useGetBulkOrdersQuery, useGetUserQuery, useUpdateBulkOrderByIdMutation } from "../../redux/slices/apiSlice";
...
const BulkOrders = () => {
  ...
  const {data,isFetching,refetch} = useGetBulkOrdersQuery({page:currentPage,limit});
  ...
  return (
    <div>
      <div className="p-4">
     <h1 className="text-2xl mb-2">Bulk Orders</h1>
      <Table
  columns={columns}
